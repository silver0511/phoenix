...
public:
    ...
    void SetArgs(const std::string &strArg1, const std::string &strArg2, const std::string &strArg3, const std::string &strArg4, const std::string &strArg5, const std::string &strArg6);
    void SetArgs(const std::string &strArg1, const std::string &strArg2, const std::string &strArg3, const std::string &strArg4, const std::string &strArg5, const std::string &strArg6, const std::string &strArg7);
...
public:
    ...
    int Sadd(const std::string &strKey, const std::vector<std::string> &vector, long *pnVal, Pipeline = nullptr);
    ...
    int Hsan(const std::string &strkey, std::string& strCursor,  long nCount, std::map<std::string, std::string> *pmapVal, Pipeline ppLine = nullptr);
    int Hset(const std::string &strKey, const std::string &strField, const std::string &strVal, long *pnVal = nullptr, Pipeline ppLine = nullptr);
    ...
    int Zadd(const std::string &strKey, unsigned long long dScore, const std::string &strElem, long *pnVal = nullptr, Pipeline = nullptr);
    ...
    int Zrangebyscore(const std::string &strKey, unsigned long long dMin, int nSpan, std::vector<std::string> *pvecVal, Pipeline ppLine = nullptr);
    int Zrangebyscore(const std::string &strKey, unsigned long long dMin, unsigned long long dMax, std::map<unsigned long long, std::string> *pmapVal, Pipeline ppLine = nullptr);
    int ZrangeWithScorebySpan(const std::string &strKey, unsigned long long dMin, int nSpan, std::map<std::string, std::string> *pmapVal, Pipeline ppLine = nullptr);
    ...
    int Zremrangebyscore(const std::string &strKey, unsigned long long dMin, unsigned long long dMax, long *pnVal = nullptr, Pipeline ppLine = nullptr);
    ...
    int Zrevrangebyscore(const std::string &strKey, unsigned long long dMax, int nSpan, std::vector<std::string> *pvecVal, Pipeline ppLine = nullptr);
    int Zrevrangebyscore(const std::string &strKey, unsigned long long dMax, int nSpan, std::map<unsigned long long, std::string> *pmapVal, Pipeline ppLine = nullptr);
	...
	//lua
	int Scriptload(const std::string &strKey, std::string *pstrVal, Pipeline ppLine = nullptr);
	int Evalsha(const std::string &strKey, const std::string &strField, std::string *pstrVal, Pipeline ppLine = nullptr);
	int Evalsha(const std::string &strKey, const std::string &strField, std::vector<std::string> *pvecVal, Pipeline ppLine = nullptr);
...
private:
    ...
    int ExecuteImpl(const std::string &strCmd, const P1 &tArg1, const P2 &tArg2, const P3 &tArg3, const P4 &tArg4, const P5 &tArg5, const P6 &tArg6, int nSlot, Pipeline ppLine,
                   TFuncFetch funcFetch, TFuncConvert funcConv = FUNC_DEF_CONV)
    {
        CRedisCommand *pRedisCmd = new CRedisCommand(strCmd, !ppLine);
        pRedisCmd->SetArgs(tArg1, tArg2, tArg3, tArg4, tArg5, tArg6);
        pRedisCmd->SetSlot(nSlot);
        pRedisCmd->SetConvFunc(funcConv);
        int nRet = Execute(pRedisCmd, ppLine);
        if (nRet == RC_SUCCESS && !ppLine)
    ...
    int ExecuteImpl(const std::string &strCmd, const P1 &tArg1, const P2 &tArg2, const P3 &tArg3, const P4 &tArg4, const P5 &tArg5, const P6 &tArg6, const P7 &tArg7, int nSlot, Pipeline ppLine,
                   TFuncFetch funcFetch, TFuncConvert funcConv = FUNC_DEF_CONV)
    {
        CRedisCommand *pRedisCmd = new CRedisCommand(strCmd, !ppLine);
        pRedisCmd->SetArgs(tArg1, tArg2, tArg3, tArg4, tArg5, tArg6, tArg7);
        pRedisCmd->SetSlot(nSlot);
        pRedisCmd->SetConvFunc(funcConv);
        int nRet = Execute(pRedisCmd, ppLine);
        if (nRet == RC_SUCCESS && !ppLine)
