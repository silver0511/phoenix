...
bool CCrc32::ComputeCrc32(const uint8* apuiFileData, uint32 auiLength, uint32* apuiOut)
{
	crc32_context crc32_ctx;

	CRC32_Init(&crc32_ctx);
	CRC32_Update(&crc32_ctx, apuiFileData, (int)auiLength);
	CRC32_Finish(&crc32_ctx, apuiOut);

	return true;
}


void CCrc32::CRC32_Init(crc32_context * ctx)
{
    ctx->value = 0xFFFFFFFF;
}


void CCrc32::CRC32_Update(crc32_context * ctx, const unsigned char * input, int ilen)
{
...
void CCrc32::CRC32_Finish(crc32_context * ctx, uint32 * value)
{
