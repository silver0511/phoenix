...
#-----------begin --------------------------------
BuildBin  'scroute' '../server_route/scroute/linux_prj'
BuildBin  'gcroute' '../server_route/gcroute/linux_prj'
BuildBin  'pcroute' '../server_route/pcroute/linux_prj'
#-----------end--------------------------------
...
echo  "==================route server build duration" $duration "seconds=================="
