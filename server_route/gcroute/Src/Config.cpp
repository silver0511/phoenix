...
//	goLocalServerInfo.mwServerPort=htons(goLocalServerInfo.mwServerPort);
	goLocalServerInfo.mwServerType = GC_ROUTE;
	goLocalServerInfo.GenServerID();

	moIniFile.GetValue("groupid","Server",m_sgroupid,"gcrouter");
    moIniFile.GetValue("servertype","Server",m_sapptype,"app");
    ...
    moIniFile.GetValue("grouppushinterval","Server",m_grouppushinterval,200);
